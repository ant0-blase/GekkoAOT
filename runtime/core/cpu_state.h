...
// Host-side CPU ABI used by GekkoAOT's standalone runtime.
// Layout is GekkoAOT CPU ABI v4 and matches the DolRecomp generated-code contract.
...
static_assert(sizeof(void*) == 8, "GekkoAOT CPU ABI v4 requires a 64-bit host");
static_assert(sizeof(CPUState) == 3536, "GekkoAOT CPUState ABI v4 layout drifted");
#endif
